          ...
          <div className="relative mt-16 h-auto lg:mt-1 py-5">
            <div className="mb-4 text-white text-2xl font-bold">
              ...
              <ul>
                {amigos.map((amigo) => (
                  <li key={amigo}>
                    <button className="text-white" type="button" onClick={() => handleFriendClick(amigo)}>
                      {amigo}
                    </button>
                  </li>
                ))}
          ...
          {chatAberto && (
            <div className="relative mt-16 h-auto lg:mt-1 py-5">
              <div>
                ...
                <input type="text" placeholder="Digite sua mensagem" value={msg} onChange={handleChange} />
                <button type="button" onClick={() => enviarMensagem(msg)}>Enviar</button>
              </div>
            </div>
          )}
        </div>
